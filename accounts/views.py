...
from .serializers import UserRefisterSerializer, UserSerializer
...
class UserViewSet(viewsets.ViewSet):
    ...
    def partial_update(self, request, pk=None):
        ...
        if user != request.user:
            return Response({'permossion denied':'you are not the owner'}, status=status.HTTP_400_BAD_REQUEST)
